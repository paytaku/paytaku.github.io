...
const DEFAULT_PICKS = [
  {
    "slug": "wesmo-oshitoku",
    "capYen": 32000,
    "name": "Wesmo!推しトクキャンペーン 毎月抽選で最大32,000ポイント",
    "rate": "1等32,000pt(100名)／2等10,000pt(500名)／3等1,000pt(1,000名)",
    "period": "毎月開催・12月まで",
    "expires": "2026-12-31",
    "how": [
      "全国170万か所以上のWesmo!加盟店（コンビニ・ドラッグストア・スーパー・家電量販店・BLUEタグの店など）で使う",
      "同月内に5回以上、かつ合計5,000円（税込）以上をWesmo!で決済する",
      "エントリー不要。条件を満たすと自動的に抽選対象になる"
    ],
    "note": "対象月内に条件を満たすと、翌月以降に抽選でWESTERポイントが当たる（基本ポイント扱い）。さらに対象店舗（EDION・OK・成城石井・くら寿司など）でのWesmo!決済は期間限定でWESTERポイントが基本の8倍になるキャンペーンもあり、併用できる。［確認日: 2026-09-05／出典: WESTERポータル公式］",
  ...
  },
  {
    ...
    "note": "店舗別Vクーポンと併用できる、いわば「はしご」ボーナス。1店舗で終わらせず複数店で使うほど有利になる。［確認日: 2026-08-09］",
    "url": "https://www.smbc-card.com/mem/cardinfo/26/cardinfo7224756.jsp",
    "image": "assets/campaign-images/優先決済を編集-1788490113768.jpg"
  },
  {
    ...
    "image": "assets/campaign-images/優先決済を編集-1788490215723.jpg"
  },
  {
  ...
  },
  {
    ...
    "how": [
      ...
      "Apple Pay経由でJAL Payを使って支払う(※Suica等へのチャージも可能)"
    ],
    ...
    "image": "assets/campaign-images/優先決済を編集-1788490293429.jpg"
  },
  {
    ...
    "image": "assets/campaign-images/優先決済を編集-1788490326412.jpg"
  },
  {
    ...
    "url": "https://www.family.co.jp/campaign/spot/2609_fmcollab45_cp_PxUFlwgK.html",
    "image": "assets/campaign-images/優先決済を編集-1788490356350.jpg"
  },
  {
    ...
    "period": "9/1〜10/15",
    "how": [
      "対象の交通事業者（北陸鉄道/遠州鉄道/伊豆箱根鉄道(駿豆線のみ対象)/長良川鉄道/Osaka Metro/大阪モノレール/北大阪急行電鉄/京都丹後鉄道/近畿日本鉄道(生駒ケーブルを除く)/神戸市営地下鉄/神戸新交通/山陽電鉄/阪急電鉄(神戸高速線を除く)/南海電鉄/能勢電鉄）でスマホのタッチ決済を使う",
    ...
    "expires": "2026-10-15",
    "image": "assets/campaign-images/優先決済を編集-1788490393292.jpg"
  },
  {
  ...
  },
  {
    ...
    "image": "assets/campaign-images/優先決済を編集-1788490997449.jpg"
  },
  {
    ...
    "image": "assets/campaign-images/優先決済を編集-1788491132537.jpg"
  },
  {
  ...
  },
  {
    ...
    "image": "assets/campaign-images/優先決済を編集-1788489750507.jpg"
  },
  {
...
const DEFAULT_STORES = [
  ...
  },
  {
    ...
    "cards": [
      ...
      {
        "name": "Wesmo!",
        "rate": "基本のWESTERポイント8倍還元（期間限定）",
        "method": "Wesmo!アプリでのSmart Code決済",
        "note": "対象店舗でのWesmo!決済で、WESTERポイント（基本）が8倍還元になるキャンペーン対象店舗。期間：2026年11月1日〜12月29日。通常時の基本還元率・上限額は公式サイトで要確認。別途「Wesmo!推しトクキャンペーン」（月5回・合計5,000円以上の利用で最大32,000ポイント抽選、エントリー不要、12月まで毎月開催）の対象にもなる。［確認日: 2026-09-05／出典: WESTERポータル公式］",
        "url": "https://wester.jr-odekake.net/",
        "expires": "2026-12-29"
      }
    ]
  ...
  },
  {
    ...
    "cards": [
      ...
      },
      {
        ...
        "rate": "基本のWESTERポイント8倍還元（期間限定）",
        "method": "Wesmo!アプリでのSmart Code決済",
        "note": "対象店舗でのWesmo!決済で、WESTERポイント（基本）が8倍還元になるキャンペーン対象店舗。期間：2026年9月1日〜10月31日。通常時の基本還元率・上限額は公式サイトで要確認。別途「Wesmo!推しトクキャンペーン」（月5回・合計5,000円以上の利用で最大32,000ポイント抽選、エントリー不要、12月まで毎月開催）の対象にもなる。［確認日: 2026-09-05／出典: WESTERポータル公式］",
        "url": "https://wester.jr-odekake.net/",
        "expires": "2026-10-31"
      }
    ],
    ...
    "cards": [
      {
        "name": "指定なし（リクルートID）",
        "rate": "50%",
        "method": "店内の注文QRコードからモバイルオーダーを起動してリクルートIDでログインし、1人あたり税込1,000円以上のご注文・お会計を行うこと。特定の決済手段の指定はありません。",
        "note": "還元上限は1人あたり1,000ポイント（期間中初回1回限り）。加算は500～1,000ポイント（100ポイント未満切り捨て）。エントリーは不要。［確認日: 2026-09-04／出典: https://www.hotpepper.jp/campaign/login_cp_202609/］",
        "url": "https://www.hotpepper.jp/campaign/login_cp_202609/",
        "expires": "2026-09-30"
      }
    ]
  },
    ...
    "cards": [
      {
        ...
        "rate": "基本のWESTERポイント8倍還元（期間限定）",
        "method": "Wesmo!アプリでのSmart Code決済",
        "note": "対象店舗でのWesmo!決済で、WESTERポイント（基本）が8倍還元になるキャンペーン対象店舗。期間：2026年9月1日〜10月31日／2026年11月1日〜12月29日。通常時の基本還元率・上限額は公式サイトで要確認。別途「Wesmo!推しトクキャンペーン」（月5回・合計5,000円以上の利用で最大32,000ポイント抽選、エントリー不要、12月まで毎月開催）の対象にもなる。［確認日: 2026-09-05／出典: WESTERポータル公式］",
        "url": "https://wester.jr-odekake.net/",
        "expires": "2026-12-29"
      }
    ]
